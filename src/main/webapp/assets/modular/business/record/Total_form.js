...
//陪审员动态添加
        ...
        form.on('radio(plaintiffType)', function(data){
            ...
            var unitType1='<div class="layui-form-item">\n' +
                ...
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" id="accuser_short" name="accuse_short" required  lay-verify="required" placeholder="请输入原告简称" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item">\n' +
                '                    <label class="layui-form-label layui-form-required">法人代表</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" id="accuser_represent" name="accuser_represent" required lay-verify="required" placeholder="请输入法人代表" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item\">\n' +
                '                    <label class="layui-form-label layui-form-required">法人职务</label>\n' +
                '                    <div class="layui-input-block\">\n' +
                '                        <input type="text" id="accuser_duty" name="accuser_duty" required  lay-verify="required" placeholder="请输入法人职务" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                </div>';
            if (type=="2"){
        ...
        const handleDefendantRadioChange = (data) => {
            var type=data.value;
            const defendantIndex = data.elem?.getAttribute(('data-index'))
            if(!defendantIndex) {
                return;
            }
            var personType2 =
                '<div id="mychange'+defendantIndex+'">'+
                '                <div class="layui-form-item">\n' +
                '                    <label class="layui-form-label layui-form-required">被告姓名</label>\n' +
                '                    <div class="layui-input-block">\n '+
                '                        <input type="text"  id="defendant'+num_defend+'" name="defendant'+num_defend+'" required  lay-verify="required" placeholder="请输入被告姓名" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item">\n' +
                '                    <label class="layui-form-label layui-form-required">被告住址</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" id="defendant_address'+num_defend+'" name="defendant_address'+num_defend+'" required  lay-verify="required" placeholder="请输入被告住址" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                   </div>'+
                '                </div>';
            ...
            var unitType2=
                ...
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" id="defendant'+num_defend+'" name="defendant'+num_defend+'" required  lay-verify="required" placeholder="请输入被告全称" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item">\n' +
                '                    <label class="layui-form-label layui-form-required">被告简称</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" id="defendant_short'+num_defend+'" name="defendant_short'+num_defend+'" required  lay-verify="required" placeholder="请输入被告简称" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item">\n' +
                '                    <label class="layui-form-label layui-form-required">法人代表</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text" id="defendant_representative'+num_defend+'" name="defendant_representative'+num_defend+'" required  lay-verify="required" placeholder="请输入法人代表" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '                <div class="layui-form-item">\n' +
                '                    <label class="layui-form-label layui-form-required">法人职务</label>\n' +
                '                    <div class="layui-input-block">\n' +
                '                        <input type="text"  id="defendant_duty'+num_defend+'" name="defendant_duty'+num_defend+'" required  lay-verify="required" placeholder="请输入法人职务" autocomplete="off" class="layui-input">\n' +
                '                    </div>\n' +
                '                   </div>'+
                '                </div>';
            if (type=="2"){
                $("#mychange"+defendantIndex).html(personType2);
                form.render();
            }
            else{
                $("#mychange"+defendantIndex).html(unitType2);
                form.render();
            }
        }


        form.on('radio(defendantType'+ num_defend  + ')', handleDefendantRadioChange);
        ...
        $("#add_defendant").click(function () {
            ...
            var str =
                ...
                '<div class="layui-input-block">'+
                '<input type="radio" data-index="'+num_defend+ '"name=defendant_type'+num_defend+ ' lay-filter="defendantType'+num_defend+ '"value="1" title="单位" checked>'+
                ' <input type="radio" data-index="'+num_defend + '"name=defendant_type'+num_defend+' lay-filter="defendantType'+num_defend+ '"value="2" title="个人">'+
                ' </div>'+
                '</div>'+
                '</div>'+
                '<div class="layui-col-md3">'+
                '<div class="layui-btn-group">'+
                '<button id="add_defendant'+num_defend+'" type="button" class="layui-btn layui-btn-primary layui-btn-sm remove_defendent"'+
                ' data-type="text">'+
                '<i class="layui-icon">&#xe640;</i>'+
                '</button>'+
                '</div>'+
                '</div>'+
                '</div>'+
                '<div id="mychange'+num_defend+'">'+
                '<div class="layui-form-item">'+
                '<label class="layui-form-label layui-form-required">被告全称</label>'+
                '<div class="layui-input-block">'+
                '<input type="text" id="defendant'+num_defend+'" name="defendant'+num_defend+'" required lay-verify="required" placeholder="请输入被告全称"'+
                ...
                '<label class="layui-form-label layui-form-required">被告简称</label>'+
                '<div class="layui-input-block">'+
                '<input type="text" id="defendant_short'+num_defend+'" name="defendant_short'+num_defend+'" required lay-verify="required" placeholder="请输入被告简称"'+
                'autocomplete="off" class="layui-input">'+
                '</div>'+
                '</div>'+
                '<div class="layui-form-item">'+
                '<label class="layui-form-label layui-form-required">法人代表</label>'+
                '<div class="layui-input-block">'+
                '<input type="text" id="defendant_representative'+num_defend+'" name="defendant_representative'+num_defend+'" required lay-verify="required" placeholder="请输入法人代表"'+
                ' autocomplete="off" class="layui-input">'+
                ' </div>'+
                '</div>'+
                '<div class="layui-form-item">'+
                '<label class="layui-form-label layui-form-required">法人职务</label>'+
                '<div class="layui-input-block">'+
                '<input type="text" id="defendant_duty'+num_defend+'" name="defendant_duty'+num_defend+'" required lay-verify="required" placeholder="请输入法人职务"'+
                'autocomplete="off" class="layui-input">'+
                '</div>'+
                '</div>'+
                ' </div>'+
                '<div class="layui-form-item">'+
                '<label class="layui-form-label" style="text-align: center; margin-top: -8px;">委托诉讼</br>代理人</label>'+
                '<div class="layui-input-block">'+
                ' <input type="text" name="agent'+num_defend+'" val="2" required lay-verify="required" placeholder="请输入委托诉讼代理人"'+
                ' autocomplete="off" class="layui-input">'+
                '</div>'+
                '</div>'+
                '<div class="layui-form-item" style="margin-top: 11px;">'+
                '<label class="layui-form-label" style="text-align: center;margin-top: -8px;">委托诉讼</br>代理人单位</label>'+
                ' <div class="layui-input-block">'+
                ' <input type="text" name="agent_address'+num_defend+'" val="2" required lay-verify="required" placeholder="请输入委托诉讼代理人单位"'+
                'autocomplete="off" class="layui-input">'+
                '</div>'+
                '</div>'+
                ' </form>'+
                '</div>'+
                ' </div>'
            $("#form_defendant").append(str);
            form.on(`radio(defendantType${num_defend})`, handleDefendantRadioChange);
            form.render();
        });
        //删除动态添加的被告
        $("body").on('click', ".remove_defendent", function () {
            //元素移除前校验是否被引用
            var approvalName = $(this).parent().parent().prev('div.layui-form-item').children().val();
        ...
        form.on('radio(is_counterclaim)',function (data){
            var type=data.value;
            var counterclaim_html="<div id =\"lawsuitd_counterclaim_item\">\n" +
        ...
        form.on('radio(is_todayreply)',function (data){
            var type=data.value;
            var todayreply_html="<div id =\"right_today_counter\">\n" +
                "                    <div id=\"todayreplyitem1\">\n" +
                "                        <div class=\"layui-form-item\" style=\"margin-top: 11px;\">\n" +
                "                            <label class=\"layui-form-label\">\n" +
        ...
        $("#counterclaim").on('click','#counterclaimitem_add',function (){
            ...
            var counterclaim_html="            <div class=\"layui-form-item\" id=\"couterclaimitem"+counterclaimnum+"\" style=\"margin-top: 11px;\">\n" +
                ...
                "</div>"+
                "</div>";
            $("#lawsuitd_counterclaim_item").append(counterclaim_html);
        });
        //添加反诉被告答辩内容
        var todayreplynum=1;
        $("#counterclaim").on('click','#todayreplyitem_add',function (){
            ...
            var todayreply_html="            <div class=\"layui-form-item\" id=\"todayreplyitem"+todayreplynum+"\" style=\"margin-top: 11px;\">\n" +
                ...
                "                </div>\n" +
                "            </div>";
            $("#right_today_counter").append(todayreply_html);
        });
        ...
        // form.on('submit(button_delivery)', function(data){
        // form.on('submit(button_ofAttendantQuestion)', function(data){
...
//双方是否调解表格
        ...
        $("#button_mediate_defendant").click(function () {
            ...
            var str =
                ...
                '<div class="layui-col-md9">\n'+
                '<div class="site-title">'+
                '<div class="layui-form" id="mediated_is_mediate'+mediate_defendantnum+'">'+
...
//电子文书送达表格
        ...
        form.on('submit(button_delivery)', function(data){
            ...
            var str =
                ...
                '<div class="layui-col-md9">'+
                '<div class="site-title">'+
                '<div class="layui-form" id="delivery_is_deliveryd'+ElectronicInstruments+'">'+
        ...
        $("#button_text").click(function () {
            $("#based_chief_judge").find("input,textarea").each(function () {
                alert($(this).val());
            });
        });
