...
public class BasicInfoServiceImpl extends ServiceImpl<BasicInfoMapper, BasicInfo> implements BasicInfoService {
    ...
    public void judgeRandomInquiry(String courtNumber, JSONObject courtInvestigateObject) {
        ...
        List<JudgeRandomInquiry> judgeRandomInquiries = getJudgeRandomInquiries(courtNumber);
        if (judgeRandomInquiries == null || judgeRandomInquiries.size() <= 0) {
            JSONObject inquiryInfoObject = blankJudgeInquiry();
        ...
        if (judgeInquiryAfterAccuserClaimArray == null || judgeInquiryAfterAccuserClaimArray.size() <= 0) {
            judgeInquiryAfterAccuserClaimArray.add(blankJudgeInquiry());
        }
        if (judgeInquiryAfterDefendantReplyArray == null || judgeInquiryAfterDefendantReplyArray.size() <= 0) {
            judgeInquiryAfterDefendantReplyArray.add(blankJudgeInquiry());
        }
        if (judgeInquiryBeforeSummarize == null || judgeInquiryBeforeSummarize.size() <= 0) {
            judgeInquiryBeforeSummarize.add(blankJudgeInquiry());
        }
    ...
    public List<JudgeRandomInquiry> getJudgeRandomInquiries(String courtNumber) {
    ...
    public JSONObject blankJudgeInquiry() {
