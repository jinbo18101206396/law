...
public class AllegeController {
     ...
     * @date 2022/01/21
     */
    @PostResource(name = "保存诉讼请求和事实理由", path = "/allege/add")
     ...
     * @date 2022/01/21
     */
    @PostResource(name = "通过ID编辑诉讼请求和事实理由", path = "/allege/edit")
    public ResponseData editById(@RequestBody @Validated(AllegeRequest.edit.class) AllegeRequest allegeRequest) {
        allegeService.updateById(allegeRequest);
        return new SuccessResponseData();
    }
